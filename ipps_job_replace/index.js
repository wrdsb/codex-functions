module.exports = function (context, data) {
    ...
    // We use the Job's job_code as the Cosmos DB record's id
    if (new_codex_record.job_code) {
        new_codex_record.id = new_codex_record.job_code;
    }
    ...
    flynn_event = {
        ...
        eventType: 'Codex.IPPS.Job.Replace',
