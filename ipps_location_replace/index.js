module.exports = function (context, data) {
    ...
    // We use the Location's location_code as the Cosmos DB record's id
    if (new_codex_record.location_code) {
        new_codex_record.id = new_codex_record.location_code;
    }
    ...
    flynn_event = {
        ...
        eventType: 'Codex.IPPS.Location.Replace',
