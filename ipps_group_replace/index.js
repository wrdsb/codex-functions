module.exports = function (context, data) {
    ...
    // We use the Groups's employee_group_code as the Cosmos DB record's id
    if (new_codex_record.employee_group_code) {
        new_codex_record.id = new_codex_record.employee_group_code;
    }
    ...
    flynn_event = {
        ...
        eventType: 'Codex.IPPS.Group.Replace',
